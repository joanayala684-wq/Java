...
public class EjemploFechas4 {
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println("D�a de la semana:"+fecha.getDayOfWeek());
			System.out.println("D�a de la semana:"+fecha.getDayOfWeek().getDisplayName(TextStyle.FULL,Locale.getDefault()));
			System.out.println("D�a de la semana:"+fecha.getDayOfWeek().getValue()); /* en n�mero */
		...
		System.out.println("N�mero de d�as entre las dos fechas:"+dias);
		
		Period period = Period.between(fecha,fechaActual);
	    int diff = period.getDays();
	    int meses =period.getMonths();
	    int annos= period.getYears();
	    System.out.println("N�mero de d�as entre las dos fechas:"+diff+",meses:"+meses+",a�os:"+annos);
		...
		System.out.println("N�mero de horas entre las dos:"+horas);
		
	    Duration duration = Duration.between(ahora,despues);
	    long diff2 = duration.toHours();
	    System.out.println("N�mero de horas entre las dos horas:"+diff2);
