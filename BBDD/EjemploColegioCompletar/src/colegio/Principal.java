	...
	public static void main(String[] args) {
		...
		do	
		{
			...
			case 2:
				...
				Curso cur= new Curso (descripcion, curso, aula);
				int filas1;
				try {
					filas1 = bd.añadir_Curso(cur);
					switch (filas1){
					case 1:
						System.out.println("\nCurso Añadido");
						break;
			...
			case 6:
				...
				try {
					...
					System.out.println(",iaw"+e.getMessage());
				}
				break;
			...
			case 10:
				...
				bd.buscarAlumnoMat(matricula);
				if (alumnos.size()==0)
					System.out.println("no hay alumnos con la matricula mayor");
				else 
